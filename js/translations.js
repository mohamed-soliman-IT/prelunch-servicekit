const translations = {
    "en": {
        ...
        "services": {
            ...
            "plumbing": {
                "title": "Plumbing",
                "description": "From leaky faucets to major pipe repairs, our skilled plumbers handle every water issue with speed and precision, ensuring your home stays dry, comfortable, and worry-free.",
                "features": [
            ...
            "electrical": {
                ...
                "description": "From installations to emergency repairs, our certified electricians keep your home or business powered, safe, and compliant with all regulations—so you can focus on what matters.",
                "features": [
            ...
            "mechanical": {
                ...
                "description": "Keep your car running smoothly with our expert mechanical services. From routine maintenance to complex repairs, our experienced technicians bring skill and care to every job—ensuring your vehicle is safe, reliable, and ready for the road.",
                "features": [
        ...
        "courses": {
            ...
            "subtitle": "Unlock your potential with hands-on training programs designed and delivered by professionals.",
            "levels": {
                "beginner": "Beginner",
        ...
        "howItWorks": {
            ...
            "steps": {
                "requestService": {
                    ...
                    "description": "Simply download our app and submit a service request. Share your needs, location, and preferred time — and we’ll instantly connect you with trusted, qualified technicians nearby."
                },
                "chooseTechnician": {
                    "title": "Choose Your Technician",
                    "description": "Browse detailed technician profiles, complete with ratings, experience, and past work. Pick the expert who best fits your requirements and schedule."
                },
                "getJobDone": {
                    "title": "Get the Job Done",
                    "description": "Your selected technician will arrive on time, fully prepared to deliver a professional service. From start to finish, we ensure quality, reliability, and peace of mind."
                },
                "rateReview": {
                    "title": "Rate and Review",
                    "description": "Once the job is done, share your feedback by rating and reviewing the technician. Your insights help us maintain high standards and guide others in choosing the right professional."
                }
            }
        },
        "about": {
            ...
            "vision": {
                "title": "Our Vision",
                "description": "Our vision is to become the go-to platform across the region for reliable on-demand services, where technicians thrive, and clients experience excellence they can trust."
            },
            "team": {
                "title": "Our Leadership Team",
                "members": {
                    "ceo": {
                        "name": "Dr. Mohamed Gaber",
                        "role": "CEO & Founder",
                        "bio": "With extensive experience in the service industry, Mohamed Gaber leads our company with vision and innovation."
                    },
                    "cpo": {
    ...
    "ar": {
        ...
        "services": {
            ...
            "plumbing": {
                "title": "خدمات السباكة",
                "description": "من حنفية بتسرّب لمواسير محتاجة تصليح، السباكين المحترفين بتوعنا بيحلّوا كل مشاكل السباكة بسرعة ودقة، وبيضمنوا إن بيتك يفضل جاف ومريح ومن غير قلق.",
                "features": [
            ...
            "electrical": {
                ...
                "description": "من التركيبات لحد الطوارئ، الكهربائيين المعتمدين بتوعنا بيخلّوا بيتك أو شغلك شغال بأمان ومتوافق مع كل القوانين—علشان تقدر تركز في اللي يهمك",
                "features": [
            ...
            "mechanical": {
                ...
                "description": "خلّي عربيتك دايمًا في أحسن حال مع خدماتنا الميكانيكية. من الصيانة الدورية لأعقد التصليحات، الفنيين بتوعنا عندهم الخبرة والاهتمام اللي يخلّي عربيتك آمنة، موثوقة، وجاهزة لأي مشوار.",
                // "features": [
                //     "صيانة المعدات",
                //     "خدمات الإصلاح",
                //     "دعم التركيب"
        ...
        "courses": {
            ...
            "subtitle": "طوّر نفسك بخبرة عملية ومعرفة متخصصة، مع تدريبات على إيد مدرّبين معتمدين وخبراء.",
            "levels": {
                "beginner": "مبتدئ",
                "intermediate": "متوسط",
                "advanced": "متقدم",
        ...
        "howItWorks": {
            ...
            "steps": {
                "requestService": {
                    "title": "اطلب خدمة",
                    "description":"حمّل التطبيق واطلب الخدمة اللي محتاجها. حدّد نوع الخدمة، المكان، والوقت المناسب ليك، وإحنا هنوصّلك بأفضل الفنيين القريبين منك."
                },
                "chooseTechnician": {
                    "title": "اختار الفني",
                    "description": "شوف بروفايلات الفنيين المتاحين، تقييماتهم، خبراتهم، والشغل اللي عملوه قبل كده. بعد كده، اختار الأنسب ليك."
                },
                "getJobDone": {
                    "title": "الخدمة تتنفّذ",
                    "description": "الفني اللي اخترته هيجيلك في الميعاد المحدد، ويعمل شغله باحترافية عشان يضمنلك أفضل نتيجة وراحة بال."
                },
                "rateReview": {
                    "title": "قيّم وشارك رأيك",
                    "description": "بعد ما تخلص الخدمة، قيّم تجربتك واكتب رأيك. تقييمك بيساعدنا نفضل محافظين على الجودة ويساعد غيرك يختار الفني الصح."
                }
            }
        },
        "about": {
            ...
            "team": {
                ...
                "members": {
                    "ceo": {
                        ...
                        "bio": "مع خبرة واسعة في مجال الخدمات، يقود محمد جابر شركتنا برؤية وابتكار."
                    },
                    "cpo": {
                        "name": "محمد سليمان",
                        "role": "الرئيس التنفيذي للمنتج",
...
function updateAbout(lang) {
    ...
    const memberKeys = ['ceo', 'cpo', 'cto', 'operations'];
